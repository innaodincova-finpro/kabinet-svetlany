...
function boot(html){
 ...
 names.push('standingCard','editStandingSlot','standingPlan','spreadSlots','pendingRecover','pendingRetry','takeOver','undo','editMaterial','prevHomework','passedTopics','homeworkFor','homeworkCheckFor','homeworkSolutionView','homeworkSolutionEditor','openLessonCard','reportBlocks');
