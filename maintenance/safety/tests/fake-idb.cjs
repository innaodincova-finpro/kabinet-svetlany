...
function fakeIDB(){
 ...
 tx.objectStore=()=>({get:k=>requestOp(()=>staged.get(k)),getAll:()=>requestOp(()=>[...staged.values()]),put:(v,k)=>requestOp(()=>{staged.set(k,v);return k}),delete:k=>requestOp(()=>staged.delete(k)),clear:()=>requestOp(()=>staged.clear())});
