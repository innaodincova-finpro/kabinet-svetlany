...
function boot(html){
 ...
 names.push('pendingRecover','pendingRetry','takeOver','undo','editMaterial','prevHomework','passedTopics','homeworkFor','homeworkCheckFor','homeworkSolutionView','homeworkSolutionEditor','openLessonCard','reportBlocks');
