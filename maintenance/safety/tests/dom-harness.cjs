...
function boot(html){
 ...
 let raw={};const storage={getItem:k=>Object.hasOwn(raw,k)?raw[k]:null,setItem:(k,v)=>{raw[k]=String(v)},removeItem:k=>delete raw[k],key:i=>Object.keys(raw)[i]??null,get length(){return Object.keys(raw).length}};
